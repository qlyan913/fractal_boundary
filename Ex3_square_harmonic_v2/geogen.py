...
import numpy as np
#  Create a mesh on unit square wher top are replaced by triangle snowflake
...
def koch_snowflake(new_pts,num_pts,line_to_be_divide, level):
    ...
    for i in range(len(line_to_be_divide)):
        ...
        P1 = ld[0]
        P2 = ld[1]
        New_p1, New_p2, New_p3 =divide_line([P1,P2],num_pts) 
        num_pts=num_pts+3
        new_pts=new_pts+[New_p1, New_p2, New_p3]
        
        new_line_tb_div=[[P1,New_p1],[New_p1,New_p3],[New_p3,New_p2],[New_p2,P2]]
