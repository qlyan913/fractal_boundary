...
plt.close()
PETSc.Sys.Print(f"plot of distribution of all estiamted alpha is saved in figures/distribution_alpha_n{n}_N{N}_v2.png.")
...
plt.xlabel('x')
plt.ylabel('y')
plt.savefig(f"figures/alpha_n{n}_N{N}_v2.png",dpi=500)
plt.close()
PETSc.Sys.Print(f"plot of alpha with color is saved in figures/alpha_n{n}_N{N}_v2.png")
...
plt.xlabel('x')
plt.ylabel('y')
plt.savefig(f"figures/alpha_std_n{n}_N{N}_v2.png",dpi=500)
plt.close()
PETSc.Sys.Print(f"plot of std of alpha with color is saved in figures/alpha_std_cm_n{n}_N{N}_v2.png")
