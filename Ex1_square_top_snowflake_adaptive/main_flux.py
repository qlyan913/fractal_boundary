...
plt.loglog(LL,(LL)**alpha/(LL[-1]**alpha)*(phi_2[-1]),marker='o',color='red',linestyle='dashed')
alpha=1
plt.loglog(LL,(LL)**alpha/(LL[0]**alpha)*(phi_2[0]),marker='o',color='black',linestyle='dashed')
plt.loglog(LL,(LL)**alpha/(LL[-3]**alpha)*(phi_2[-3]),marker='o',color='black',linestyle='dashed')
...
alpha=1/dim_frac
plt.loglog(LL, phi_2,marker='o',color='blue')
plt.loglog(LL,(LL)**alpha/(LL[0]**alpha)*(phi_2[0]),marker='o',color='red',linestyle='dashed')
